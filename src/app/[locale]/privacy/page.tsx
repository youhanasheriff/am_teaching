        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">
              {tLegal("introduction.title")}
            </h2>
            <p className="text-gray-700 mb-4">
              {tLegal("introduction.content1")}
            </p>
            <p className="text-gray-700">{tLegal("introduction.content2")}</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">
              {tLegal("informationCollection.title")}
            </h2>

            <h3 className="text-xl font-medium text-gray-900 mb-3">
              {tLegal("informationCollection.personalTitle")}
            </h3>
            <p className="text-gray-700 mb-4">
              {tLegal("informationCollection.personalContent")}
            </p>
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-3">
              {tLegal("informationCollection.automaticTitle")}
            </h3>
            <p className="text-gray-700 mb-4">
              {tLegal("informationCollection.automaticContent")}
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>
                ...
                help us operate our business (payment processors, email
                services, analytics)
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              information is typically retained for the duration of your account
              plus a reasonable period thereafter.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mb-2">
                Email: privacy@amteachings.com
              </p>
              <p className="text-gray-700 mb-2">
                General Contact: aya@amteachings.com
              </p>
              <p className="text-gray-700">
                Response Time: We aim to respond to all privacy inquiries within
                48 hours.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              with applicable data protection laws. Any disputes arising from
              this policy will be resolved in accordance with our Terms of
              Service.
            </p>
          </section>
        </div>
